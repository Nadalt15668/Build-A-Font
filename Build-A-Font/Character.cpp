...
void LoadCharacter(DrawingBoard& board, string characterName, string templateFilename, vector<RectangleShape>& mainLines)
{
	board.Clear();
...
{
	btnCharacter = new Button<DrawingBoard&, string, string, vector<RectangleShape>&>
...
void Character::SetCharacterData(string characterName, string templateFilename, vector<RectangleShape>& mainLines)
{
